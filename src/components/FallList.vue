            ...
            <table v-bind:style="{ width: newWidth }">
                ...
                <thead>
                    <tr>
                        ...
                        <th bgcolor="#83d8eb">Fall Speed</th>
                ...
                <tr v-for="(character, index) in sortedCharacters" :key="character.csspos">
                    <td>{{ranking((index + 1), character.fall)}}</td>
                    ...
                    <td bgcolor="#83d8eb"><b>{{character.fall}}</b></td>
...
export default {
  ...
  methods: {
      ranking(index, fall) {
          if (fall < this.$options.prevChar) {
              this.$options.prevChar = fall;
              this.$options.rank = index;
              return index;
          }
          else if (fall === this.$options.prevChar) {
