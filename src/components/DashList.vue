            ...
            <table v-bind:style="{ width: newWidth }">
                ...
                <thead>
                    <tr>
                        ...
                        <th bgcolor="#83d8eb">Initial Dash Speed</th>
                ...
                <tr v-for="(character, index) in sortedCharacters" :key="character.csspos">
                    <td>{{ranking((index + 1), character.dash)}}</td>
                    ...
                    <td bgcolor="#83d8eb"><b>{{character.dash}}</b></td>
...
export default {
  ...
  methods: {
      ranking(index, dash) {
          if (dash < this.$options.prevChar) {
              this.$options.prevChar = dash;
              this.$options.rank = index;
              return index;
          }
          else if (dash === this.$options.prevChar) {
