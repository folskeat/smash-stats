            ...
            <table v-bind:style="{ width: newWidth }">
                ...
                <thead>
                    <tr>
                        ...
                        <th bgcolor="#83d8eb">Horizontal Air Speed</th>
                ...
                <tr v-for="(character, index) in sortedCharacters" :key="character.csspos">
                    <td>{{ranking((index + 1), character.airmove)}}</td>
                    ...
                    <td bgcolor="#83d8eb"><b>{{character.airmove}}</b></td>
...
export default {
  ...
  methods: {
      ranking(index, airmove) {
          if (airmove < this.$options.prevChar) {
              this.$options.prevChar = airmove;
              this.$options.rank = index;
              return index;
          }
          else if (airmove === this.$options.prevChar) {
