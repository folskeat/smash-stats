            ...
            <table v-bind:style="{ width: newWidth }">
                ...
                <thead>
                    <tr>
                        ...
                        <th bgcolor="#83d8eb">Fast Fall Speed</th>
                ...
                <tr v-for="(character, index) in sortedCharacters" :key="character.csspos">
                    <td>{{ranking((index + 1), character.fastfall)}}</td>
                    ...
                    <td bgcolor="#83d8eb"><b>{{character.fastfall}}</b></td>
...
export default {
  ...
  methods: {
      ranking(index, fastfall) {
          if (fastfall < this.$options.prevChar) {
              this.$options.prevChar = fastfall;
              this.$options.rank = index;
              return index;
          }
          else if (fastfall === this.$options.prevChar) {
