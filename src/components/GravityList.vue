            ...
            <table v-bind:style="{ width: newWidth }">
                ...
                <thead>
                    <tr>
                        ...
                        <th bgcolor="#83d8eb">Gravity Multiplier</th>
                ...
                <tr v-for="(character, index) in sortedCharacters" :key="character.csspos">
                    <td>{{ranking((index + 1), character.gravity)}}</td>
                    ...
                    <td bgcolor="#83d8eb"><b>{{character.gravity}}</b></td>
...
export default {
  ...
  methods: {
      ranking(index, gravity) {
          if (gravity < this.$options.prevChar) {
              this.$options.prevChar = gravity;
              this.$options.rank = index;
              return index;
          }
          else if (gravity === this.$options.prevChar) {
