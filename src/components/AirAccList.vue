            ...
            <table v-bind:style="{ width: newWidth }">
                ...
                <thead>
                    <tr>
                        ...
                        <th bgcolor="#83d8eb">Air Acceleration</th>
                ...
                <tr v-for="(character, index) in sortedCharacters" :key="character.csspos">
                    <td>{{ranking((index + 1), character.airacc)}}</td>
                    ...
                    <td bgcolor="#83d8eb"><b>{{character.airacc}}</b></td>
...
export default {
  ...
  methods: {
      ranking(index, airacc) {
          if (airacc < this.$options.prevChar) {
              this.$options.prevChar = airacc;
              this.$options.rank = index;
              return index;
          }
          else if (airacc === this.$options.prevChar) {
