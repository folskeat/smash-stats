            ...
            <table v-bind:style="{ width: newWidth }">
                ...
                <thead>
                    <tr>
                        ...
                        <th bgcolor="#83d8eb">Full Hop Height</th>
                ...
                <tr v-for="(character, index) in sortedCharacters" :key="character.csspos">
                    <td>{{ranking((index + 1), character.fullhop)}}</td>
                    ...
                    <td bgcolor="#83d8eb"><b>{{character.fullhop}}</b></td>
...
export default {
  ...
  methods: {
      ranking(index, fullhop) {
          if (fullhop < this.$options.prevChar) {
              this.$options.prevChar = fullhop;
              this.$options.rank = index;
              return index;
          }
          else if (fullhop === this.$options.prevChar) {
